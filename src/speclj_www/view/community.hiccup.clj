...
[:h4 "Mailing List"]
[:p "You can join our mailing list <a href=\"https://groups.google.com/group/speclj?pli=1\" target=\"blank\">here</a>"]
...
[:h4 "Chat"]
[:p "If you want to chat with us and other users go to <a href=\"http://webchat.freenode.net/\">freenode's</a> browser based irc chat client and join the speclj channel."]