...
(def get-route-and-page-name
  [["/" "index"]
   ...
   ["/specljs_tutorial" "specljs_tutorial/step1"]
   ["/specljs_tutorial/step1" "specljs_tutorial/step1"]
   ["/specljs_tutorial/step2" "specljs_tutorial/step2"]
   ["/specljs_tutorial/step3" "specljs_tutorial/step3"]
   ["/specljs_tutorial/step4" "specljs_tutorial/step4"]
   ["/specljs_tutorial/step5" "specljs_tutorial/step5"]
   ["/specljs_tutorial/step6" "specljs_tutorial/step6"]
   ["/specljs_tutorial/step7" "specljs_tutorial/step7"]
   ["/community" "community"]
   ["/license" "license"]
   ["/docs/" "docs/index"]
